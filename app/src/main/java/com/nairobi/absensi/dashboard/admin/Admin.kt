...
@Composable
fun Admin(navController: NavController, userViewModel: UserViewModel) {
    ...
    navController.addOnDestinationChangedListener { _, dest, _ ->
        if (dest.route != "add" && dest.route != "edit" && dest.route != "admin") {
            userViewModel.clean()
        }
    }
    ...
    if (userViewModel.loading.value) {
        ...
        Box(
            ...
            Column(
                ...
                AppBar(navController = navController, title = "Admin")
                FormText(
                    text = filter ?: "",
                    label = "Cari Admin",
